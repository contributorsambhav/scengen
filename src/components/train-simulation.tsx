...
import { Activity, ChevronLeft, ChevronRight, Clock, Gauge, MapPin, Navigation, Pause, Play, RotateCcw, Square, Train, TrendingUp, Zap } from 'lucide-react';
    ...
    <div className="w-full min-h-screen bg-gradient-to-br from-slate-900 to-slate-800 text-white">
      ...
      {!simulationData && (
        <div className="p-8 m-6 border-2 border-dashed border-slate-600 rounded-lg text-center bg-slate-800/50">
          <Train className="mx-auto mb-4 w-16 h-16 text-slate-400" />
          <h3 className="text-xl font-semibold text-slate-200 mb-2">No Simulation Data</h3>
          <p className="text-slate-400 mb-4">Use the Railway Builder to create a network and compute paths to see the simulation</p>
        </div>
      )}
